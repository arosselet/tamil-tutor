...
- **A birth and a death on the same day.** Feb 25, 14:52: "implement public podcast RSS feed via GitHub Pages." A public standard, and that feed is still the only feed. Feb 25, 21:35: I purged my "mobile wall hack," a contraption where phone-Gemini generated a JSON blob that I shared to a webhook, parked as a text entity in Home Assistant, and hoped my laptop would eventually pick up and sync. Too brittle, too heavy. But it was the right dream (my buddy needs state to teach me effectively) with the wrong transport. A private tunnel traded for a public standard, in that order. *(Corrected 2026-09-01 against the log. This read "purged … hours later, the feed," which puts the causation backwards. `7ff602a` lands 14:52 and `0a7c5cc` 21:35: the public standard shipped first, and the tunnel was deleted because something had replaced it. Same family as the other corrections on this page — the claim was right and the receipt had rotted.)*
