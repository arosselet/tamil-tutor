...
**Where it stands 08-02:** the past tense is **open** — 1pl-past-om, past-tense and it-tail-uchu all closed in one session once the diagnosis moved off the -ஓம் tail and onto **past-body selection** (a verb has three bodies; the body is a *choice*, and only the tail was ever being taught). Survival 25/34, engines 18/21. Delight is still **1 cold of 27** with ten days left — the week's second half has now had one day of the whole week and it is the only thing left that matters.

**Tomorrow's shape:** Table Rehearsal — mask-work at her table at speed, aimed squarely at **delight**, which is where every remaining point is. The commissioned episode (ரொம்ப நல்லா இருக்கு, the melt line in the present) lands first so the line arrives by ear before it is demanded. Also owed: **வேணும்-for-குடுங்க**, commissioned 19 days ago and shipped as M80, still untested — work it into a crowded table where the thing he wants is out of reach. And the past tense gets a **cold retest in 2–3 days, unannounced**: one unaided fire an hour after the teach is real but not yet proof. Low-power twin if he's fried: the தெரியல tape, ear only.
