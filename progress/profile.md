...
**`chunk-not-machine` CLOSED 2026-08-30 — the drawer medicine worked (5× over 19d; it revives if it comes back).** The disease was **A DRAWER OF READY-MADE NO'S**: whole memorised negatives, each a real line doing a real job somewhere, and when a negative slot opened his hand grabbed whichever was on top. On 08-30 it stopped, twice inside one phone scene — athai asked *"mama saapdaaraa?"* and he gave **saapdala**; she asked *"unakku theriyuma?"* and he gave **theriyala**, the exact word he had double-missed twenty-four hours earlier with *puriyala* then *appadi illa*. Both instant, both unaided, both **built off the verb the question just used**. **Keep the medicine, it is proven twice now:** seat-frame the substitute instead of marking it wrong (*appadi illa* corrects a wrong picture about him), then *build, don't grab* — and demand the negative with a question that hands him the verb. Carve, then ambush; never more reps.
