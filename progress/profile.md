...
**Tomorrow's shape (08-06): Day 2 — The interrogation, as a FIRING day.** The faq six were already hinted-and-silent (they fire, they never seeded); now கனடாவுல இருக்கோம் · ஊரு · காரம் பரவாயில்ல have a night's ear on them too. Ask them the way the sisters will — fast, twice, overlapping. Do **not** re-teach the -ஓம் tail or -ல in chat: both rode M82 tonight and the escalate note is explicit — change the format, never loop harder. Tomorrow tests whether the ear-dose landed. Still owed, still never slotted: **புரியல-for-reopen** — and the line for it must be genuinely *unrecoverable*, not merely fast; his catch is ahead of his mouth and beat the last two attempts. Low-power twin: **M82** itself, ear only, second pass.
