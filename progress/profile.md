...
**Tomorrow's shape:** Teach Day — 2–3 generous Teach Beats on the untouched mil-table lines, firing kept light and aimed at *today's* gate haul (யாரு?, சில்லறை இருக்கா?), since density-low/lore-high has outproduced every gauntlet for a fifth session. Low-power twin if he's fried: the தெரியல soak tape — the -ல negative tail in five verbs and five mouths, ear only.
