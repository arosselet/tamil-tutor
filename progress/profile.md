...
**The live wire, named 2026-08-30: for Andrew, கேட்கு currently IS சொல்லு.** Three ear-misses read *kekkala* as "said"; then the closing fire — *tell her you'll ask him* — came back **sonnen**. The same confusion from both directions, and it predates the teach (08-29 eavesdrop, before *kekka* had ever been given). One clause, and it is enough: **சொல்லு pushes words out, கேட்கு pulls them in** — and athai's own line carries both back to back (*naan ketten / avaru onnum sollala*). Commissioned to the soak lane as a matched verb pair with the tail held still. **Do not re-drill it in chat; ambush *kekkuren* unannounced later in the week.**
