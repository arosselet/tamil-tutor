...
**Tomorrow's shape:** Story Day — one dinner-table scene carrying the three lines taught 07-31 (கை ருசி, நீங்க சாப்பிட்டீங்களா?, the -ஓம் tail), with the cold demand aimed at *yesterday's* teach: `inniki enna panninga?` answered in a room he hasn't seen. The aunties tape (frame:youknow-la) gets collected at the door — three sessions overdue. Low-power twin if he's fried: the தெரியல tape, on the feed since 07-31, ear only.
