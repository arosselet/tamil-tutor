...
**🎯 The Auto Ride Week** (written 2026-07-26, updated 07-27). Through-line: **the `public` register is one scene, not six phrases** — a whole transaction with a stranger, curb to change (நேரா போங்க → இங்க நிறுத்துங்க → எவ்ளோ ஆகும்? → ரொம்ப அதிகம் → சில்லறை இருக்கா?). 07-27 ran the ride end to end and the *sequence* carried better than any phrase would have — keep running the whole transaction, vary the fare and the street. Pieces are now met but not cold; the week's job is turning hinted into cold, not adding stops. The antifreeze kit rides *inside* the ride: a moving auto is exactly where கொஞ்சம் மெதுவா சொல்லுங்க and என்ன சொன்னீங்க? earn their keep. Catch stays ambient in the tapes, never a second headline — `frame:youknow-la` is still uncaught and still load-bearing. The trailer pitches the **-ஆச்சு / -இடுச்சு done-tail family** — the ride handed us ஆகும், its twin is the debt from 07-26 — plus **pakkam vs paakkalaam**, which Andrew asked for by name on 07-27 (see Active Gaps); a learner-requested item goes on the next menu, not into the rotation queue.
