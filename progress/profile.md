...
**Tomorrow's shape:** **Teach Day** — not Table Rehearsal again, and deliberately low-density per the standing overwhelm preference. Delight has **19 of 27 never worked**; the ticket's ⚠ UNSEEN head is all delight (**பிறந்தநாள் வாழ்த்துக்கள்** — amma's birthday lands ~Aug 24, mid-stay, so this one has a real date on it; **ஊரு**; **ரொம்ப நாளாச்சு**; **நானே எடுத்துக்கறேன்**). Generous, story-rich, no cold demand on today's teach; firing stays light and aims at *yesterday's* — the melt line and குடுங்க, both now his. Still owed: **புரியல-for-reopen got no slot on 08-04** — he understood the too-fast line instead of needing to reopen it; next attempt the line must be genuinely unrecoverable. Low-power twin: **M81** (ரொம்ப சந்தோஷம், first contact at the door), ear only.
