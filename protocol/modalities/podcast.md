...
> **Output:** `content/scripts/tierX_lessonY.md` (TTS-ready script)
...
- **Adaptation:** The Architect reads the "Scenario Context" from the Lesson Plan and expands it into a full scene (Intercept + Breakdown).
...
- **Metadata:** Write `content/lessons/tierX_lessonY.tags.json` sidecar.
...
2. **Breakdown Structure**: Ensure the Breakdown is a second Tamil exposure, NotebookLM-style, as defined in the Architect role.
