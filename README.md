...
- **Comprehension leads; production probes it.** The destination is the room ceasing to be noise — follow a new spoken exchange without captions, then join it. Teaching works a meaningful exchange until it lands, and production is how you find out what transferred: an English situation in, the target language out, offered when it is useful and never as a daily quota. Two meters, in that order: the **ear meter** (of the items tested by ear, how many came back) and the **viability floor** (of the words you recognize, the share that fires cold). A meter counts what was *tested*, never what was merely delivered — an untested denominator reports ignorance as failure, and a meter that cannot tell reading from hearing reports a chat line as a listen.
...
**It opens by giving.** The first minutes are pure receiving — coffee-and-lore: the story so far, the trailer Anna left on your phone yesterday, a tangent, a tape. Nothing is asked back, nothing is graded, and a catch-up question is a collect, not a gift. **Then the teaching**, inside whatever the day is: hear a short exchange, unpack what blocked the meaning, hear it whole again, then meet a changed example. Production probes ride along when they are useful — an English situation in, Tamil back; instant = cold, hesitation = hinted, miss = recast-and-move — and a listening lesson counts on its own. Ambiguous is never scored as cold; Anna asks rather than take the flattering reading. **Then the close**, which is where the real output is.
