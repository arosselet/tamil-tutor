# Tier 2, Mission 69 — The Hostage Situation

## Core Targets
- **Linguistic Pattern:** The Urgency Escape (pressing needs vs. polite commands)
- **Register:** embarrassment
- **Dramatic Ingredient:** genre — a confession (mild horror / hostage trope)
...
## Scenario Context
Maya confesses an embarrassing story to Raj that plays out like a mild horror "hostage" situation. She was at an extended relative's house, running incredibly late for a train. The family absolutely refused to let her leave, constantly fussing and repeatedly commanding her to eat more ("உக்காருங்க", "சாப்பிடுங்க"). Trapped by politeness, she kept awkwardly repeating her escape lines—that she was in a hurry ("அவசரம் இருக்கு") and needed to go to the station ("ஸ்டேஷனுக்கு போகணும்"). It became absurd: the more she tried to assert her urgency, the more they insisted she stay for one more idli, until she finally had to flee.

## Word Payload

**NEW (4 words):**
- **{place}-க்கு போகணும்** (*frame:needtogo-place*) — (I) need to go to {place}
- **அவசரம் இருக்கு** (*avasaram irukku*) — I'm in a hurry
- **புரியல** (*puriyala*) — I don't understand
- **{X}+ஆ** (*frame:adverb-aa*) — 'X-ly / as X' (e.g., அவசரமா)

**CALLBACKS (3 words):**
- **பிடிக்காது** (*pidikkaadhu*) — I don't like [floor-gap]
- **சொன்னாங்க** (*sonnaanga*) — They said [floor-gap]
- **நேரா** (*neera*) — Straight [floor-gap]
...
## Notes
Calibration: The learner is deep into the Trip Sprint ("ask-machine week") and needs to practice asserting urgent needs (`avasaram irukku`, `poganum`) against polite hosting pressures (`saapdunga`, `ukkarunga`). The episode leans slightly English for scaffolding due to the story form but maintains the 95% known-word floor for Tamil audio. Keep the pace crisp; the horror/scam genre framing should just provide a fun, relatable exaggerated flavor of typical family hospitality.
