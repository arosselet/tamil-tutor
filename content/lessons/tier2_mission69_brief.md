```markdown
# Tier 2, Mission 69 — The Suspicious Departure

## Core Targets
- **Linguistic Pattern:** The Exit (Urgency & Obligation)
- **Register:** suspicion
- **Dramatic Ingredient:** genre — a confession
...
## Scenario Context
It is late at night at the family home. The protagonist is desperately trying to leave for the railway station, insisting they are in an extreme hurry (`அவசரம் இருக்கு`, `station-kku poganum`). An elder family member is physically blocking the door, fussing at them to wait and eat one more bite (`கொஞ்சம் நில்லுங்க`, `இன்னும் கொஞ்சம் சாப்பிடுங்க`). However, beneath the hospitality is deep suspicion—the elder senses that this sudden rush is a cover for some hidden issue (`என்னமோ பிரச்சனை`), and refuses to let them leave without a confession.
...
- **கொஞ்சம் நில்லுங்க** (*konjam nillunga*) — Wait a moment (respectful)
- **இன்னும் கொஞ்சம் சாப்பிடுங்க** (*innum konjam saapidunga*) — Eat a little more
- **என்னமோ பிரச்சனை** (*ennamo prechanai*) — Some problem or other
...
## Vocabulary Fence (the sea — build from these)
  179 known words. The Architect should build dialogue from this pool.
...
## Notes
- **Calibration:** Target ~95%+ known words in the Intercept *as heard*. New word types capped at 5 total. Unfenced strangers hard capped at 2 (only if answered from context).
- **-aam watch:** The learner missed the -aam hearsay tail on the 3rd contact recently; it remains seeded in the background but is deliberately not chased here. The focus is purely on the exit/urgency frame operating inside the suspicion register.
```
